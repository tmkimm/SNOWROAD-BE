...
public class EventController {
    ...
    @Operation(summary="팝업, 전시 리스트 조회", description = "(이벤트) 등록된 팝업, 전시 리스트를 조회합니다. sortType : 10, 20, 30")
    ...
    @Operation(summary="팝업, 전시 메인 순위 리스트 조회", description = "(이벤트) 메인 팝업, 전시 순위 리스트를 조회합니다. ARG : PPST, ENBN")
    ...
    public PagedResponseDto<HomeEventsResponseDto> getMainRankList(@RequestParam(defaultValue = "0") int page, @PathVariable String eventTypeCd) {
...
/*    @Operation(summary="팝업, 전시 메인 추천 리스트 조회", description = "(이벤트) 메인 팝업, 전시 추천 리스트를 조회합니다.")
    ...
    @Operation(summary="팝업, 전시 메인 오픈임박 조회", description = "(이벤트) 메인 팝업, 전시 오픈임박 리스트를 조회합니다. eventTypeCd : PPST, ENBN")
    @ApiResponse(responseCode = "200", description = "조회 성공", content = @Content(schema = @Schema(implementation = HomeEventsResponseDto.class)))
    ...
    @Operation(summary="팝업, 전시 메인 마감임박 조회", description = "(이벤트) 메인 팝업, 전시 마감임박 리스트를 조회합니다. eventTypeCd : PPST, ENBN")
    @ApiResponse(responseCode = "200", description = "조회 성공", content = @Content(schema = @Schema(implementation = HomeEventsResponseDto.class)))
